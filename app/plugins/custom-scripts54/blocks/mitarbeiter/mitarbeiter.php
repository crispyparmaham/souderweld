...
<?php
    ...
    $heading = get_field('bereich');
    $desc = get_field('beschreibung');
    $cta = get_field('kontakt');

?>

    <div class="mitarbeiter-bereich">
        <div class="heading-wrap">
            <h3 class="h-m"><?php echo $heading; ?></h3>
            <span class="grid-text"><?php echo $desc; ?></span>
        </div>
        <span class="cta-text"><?php echo $cta; ?></span>
    </div>
